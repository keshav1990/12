        ...
        if (typeof current == "undefined" || current === null) {
            if ($("body").hasClass("home")) {
                ...
                if ($("body").hasClass("woocommerce") && $("h1").hasClass("page-title")) {
                    ...
                    if ($("body").hasClass("woocommerce") && $("h1").hasClass("entry-title")) {
                        current = $("h1.entry-title").html()
                    } else {
                        if ($("body").hasClass("archive") && $("h6").hasClass("title-archive")) {
                            current = $("h6.title-archive").html()
                        } else {
                            if ($("body").hasClass("search-results") && $("h6").hasClass("title-search-results")) {
                                current = $("h6.title-search-results").html()
                            } else {
                                if ($("body").hasClass("page-template-blog-excerpt-php") && $("li").hasClass("current_page_item")) {
                                    current = $("li.current_page_item").text()
                                } else {
                                    if ($("body").hasClass("page-template-blog-php") && $("li").hasClass("current_page_item")) {
                                        current = $("li.current_page_item").text()
                                    } else {
                                        if ($("h1").hasClass("post-title")) {
